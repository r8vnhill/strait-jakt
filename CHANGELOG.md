...
## Added
- **`BeProbability` Constraint:** Introduced a new constraint to validate if a value is a probability within the range [0, 1].

## Changed
- **Upgrade Kotlin version**: Upgraded Kotlin version to 2.0.21
